...
namespace Kapitalist.Web.Client.Controllers.Published
{
    ...
    [Authorize]
    [RoutePrefix("belowThreshold")]
    public class TenderBelowThresholdController : BasePublishedController
    {
        private ITenderProvider TenderProvider { get; }

        public TenderBelowThresholdController(ITenderProvider tenderProvider)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> EditTender(TenderBelowThresholdViewModel viewModel)
        {
