...
namespace Kapitalist.Web.Client.Controllers.Published
{
    ...
    [Authorize]
    [RoutePrefix("aboveThresholdEU")]
    public class TenderAboveThresholdEUController : BasePublishedController
    {
        private ITenderProvider TenderProvider { get; }

        public TenderAboveThresholdEUController(ITenderProvider tenderProvider)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> EditTender(TenderAboveThresholdEUViewModel viewModel)
        {
