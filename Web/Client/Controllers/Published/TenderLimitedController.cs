...
namespace Kapitalist.Web.Client.Controllers.Published
{
    ...
    [Authorize]
    [RoutePrefix("tenderLimited")]
    public class TenderLimitedController : BasePublishedController
    {
        private ITenderProvider TenderProvider { get; }

        public TenderLimitedController(ITenderProvider tenderProvider)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> EditTender(TenderLimitedViewModel viewModel)
        {
