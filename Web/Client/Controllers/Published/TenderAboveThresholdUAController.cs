...
namespace Kapitalist.Web.Client.Controllers.Published
{
    ...
    [Authorize]
    [RoutePrefix("aboveThresholdUA")]
    public class TenderAboveThresholdUAController : BasePublishedController
    {
        private ITenderProvider TenderProvider { get; }

        public TenderAboveThresholdUAController(ITenderProvider tenderProvider)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> EditTender(TenderAboveThresholdUAViewModel viewModel)
        {
